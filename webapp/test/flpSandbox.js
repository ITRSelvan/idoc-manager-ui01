		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IDoc Manager",
									"targetURL": "#comidocmanagerui01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comidocmanagerui01-display": {
								"semanticObject": "comidocmanagerui01",
								"action": "display",
								"description": "IDoc Manager",
								"title": "IDoc Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.idocmanagerui01",
									"url": sap.ui.require.toUrl("com/idocmanagerui01")
								}
							}
						}
					}
